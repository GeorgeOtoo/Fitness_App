...
#Add a cache decorator to run only when the database has been changed
@st.cache(allow_output_mutation=True)
def get_workouts():
    return dbs.get_all_workouts()


#since it is stored in seconds we want to format it properly
...
#if all workout is selected show every workout video in the database
